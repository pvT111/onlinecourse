        ...
        <div class="grid grid-cols-2" style="align-items: center; gap: 3rem;">
            <div>
                ...
                <p style="font-size: 1.125rem; margin-bottom: 2rem; opacity: 0.9;">
                    Khám phá kiến thức mới, nâng cao kỹ năng và phát triển sự nghiệp của bạn với các khóa học chất lượng
                    cao từ các chuyên gia hàng đầu.
                </p>
                <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                    <a href="index.php?route=courses" class="btn"
                        style="background: white; color: var(--primary-color);">Khám phá ngay</a>

                </div>
            </div>
            <div style="display: none;">
                <img src="https://images.unsplash.com/photo-1546430498-05c7b929830e?w=600" alt="Online Learning"
                    style="border-radius: 0.5rem; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1);">
            </div>
        </div>
    </div>
</section>
            ...
            <?php foreach ($courses as $course): ?>
                ...
                <a href="<?= $detailUrl ?>"
                    ...
                    <div class="p-5">
                        ...
                        <h3 class="text-gray-900 mb-2 line-clamp-2 min-h-[3rem]"><?= htmlspecialchars($course['title']) ?>
                        </h3>
